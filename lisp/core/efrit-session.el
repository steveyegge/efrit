...
;; Forward declarations to suppress warnings
...
;;; Session Transcript Persistence (for Resume)
;;
;; Saves full conversation transcripts to enable session resume.
;; Unlike the metrics-only persistence above, this stores actual messages.
...
Returns a list of alists, each containing id, snippet, created_at, message_count.
...
;; Hook into session completion to auto-save transcripts
