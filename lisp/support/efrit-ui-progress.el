;;; efrit-ui-progress.el --- Progress display for Efrit -*- lexical-binding: t -*-
...
;; Real-time progress display and loop detection for Efrit operations.
...
(provide 'efrit-ui-progress)

;;; efrit-ui-progress.el ends here
